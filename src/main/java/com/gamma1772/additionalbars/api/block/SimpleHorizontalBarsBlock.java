package com.gamma1772.additionalbars.api.block;
...
public class SimpleHorizontalBarsBlock extends SlabBlock implements IWaterLoggable {
    ...
    public SimpleHorizontalBarsBlock(Properties properties) {
        super(properties);
    }
